...
const IndexPage = () => (
        ...
        <div class="lg:w-2/3 mx-auto">
          <div class="flex flex-wrap w-full bg-gray-100 py-16 px-10 relative mb-4">
            ...
            <div class="text-center relative z-10 w-full">
              ...
              <p class="leading-relaxed">Opportunities from our patent portfolio</p>
          ...
          <div class="flex flex-wrap -mx-2">
            <div class="px-2 w-1/2">
              <div class="flex flex-wrap w-full bg-gray-100 py-8 sm:py-6 sm:px-10 px-6 relative">
                ...
                <div class="text-center relative z-10 w-full">
                  <h2 class="text-xl text-gray-900 font-medium title-font mb-2">Research Spinoffs</h2>
                  <p class="leading-relaxed">Futher develop or commercialise your research</p>
                  <a class="mt-3 text-blue-500 inline-flex items-center">Learn More
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                      <path d="M5 12h14M12 5l7 7-7 7"></path>
                    </svg>
            ...
            <div class="px-2 w-1/2">
              <div class="flex flex-wrap w-full bg-gray-100 py-8 sm:py-6 sm:px-10 px-6 relative">
                ...
                <div class="text-center relative z-10 w-full">
                  <h2 class="text-xl text-gray-900 font-medium title-font mb-2">Student Startups</h2>
                  <p class="leading-relaxed">Opportunities for students to start a company</p>
                  <a class="mt-3 text-blue-500 inline-flex items-center">Learn More
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                      <path d="M5 12h14M12 5l7 7-7 7"></path>
                    </svg>
    ...
    <section class="text-gray-600 body-font">
      <div class=" w-full bg-orange-200 px-5 py-24">
        <div class="flex flex-col text-center w-full mb-20 mx-auto">
          <h2 class="text-xs text-blue-500 tracking-widest font-medium title-font mb-1">Sounds interesting</h2>
          <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">So, how can we help?</h1>
    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-24 mx-auto flex flex-col">
        ...
        <div class="flex flex-col text-center w-full mb-10 mx-auto">
          <h3 class="text-xs text-blue-500 tracking-widest font-medium title-font mb-1">CASE STUDY</h3>
          ...
          <div class="flex flex-col sm:flex-row mt-10">
            ...
            <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
              ...
              <a class="text-indigo-500 inline-flex items-center" href="https://flow-robotics.com">Flow Robotics website
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                  <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
              </a>
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="flex w-full mb-20 flex-wrap">
      ...
      <p class="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base">Here are some of the student-led companies we've had the pleasure of supporting along the years.<br />The journey of starting a company and applying your knowledge in practice remains an invaluable experience!</p>
    </div>
